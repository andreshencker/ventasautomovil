...
export class VehiculoFotoVehiculoController {
  ...
  async find(
    ...
    return this.vehiculoRepository.fotoVehiculos(id).find(filter);
  }
  ...
  async create(
    ...
    return this.vehiculoRepository.fotoVehiculos(id).create(fotoVehiculo);
  }
  ...
  async patch(
    ...
    return this.vehiculoRepository.fotoVehiculos(id).patch(fotoVehiculo, where);
  }
  ...
  async delete(
    ...
    return this.vehiculoRepository.fotoVehiculos(id).delete(where);
  }
}
